...
@section('content')
    <div class="modal fade" id="modal-block-popin" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin"
        ...
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.babies.store') }}" method="POST" enctype="multipart/form-data">

                    @csrf
                    <div class="block block-rounded block-transparent mb-0">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Add Baby</h3>
    ...
    <div class="content">
        ...
        <a href="{{ route("user.baby-requests.index") }}" target="__blank" class="btn btn-primary push" >Add Baby</a>
